...
func (app *Server) confictResponse(w http.ResponseWriter, r *http.Request, err error) {
	log.Printf("conflict found error: %s path: %s error: %s", r.Method, r.URL.Path, err.Error())
